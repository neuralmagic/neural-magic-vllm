...
def fused_moe(
    ...
    # print("shapes:", hidden_states.shape, gating_output.shape, w1.shape, w2.shape)
    # Check constraints.
    ...
    # for mm in range(M):
    #     tw = topk_weights[mm][0]
    #     for ee in range(topk):
    #         topk_weights[mm][ee] = tw

    # topk_weights = torch.ones(M,
    #                                topk,
    #                                dtype=torch.float32,
    #                                device=hidden_states.device)
...
def single_marlin_moe(
    ...
    # assert hidden_states.shape[0] == gating_output.shape[0], (
    #     "Number of tokens mismatch")
    # assert hidden_states.shape[1] * 2 == w.shape[2], "Hidden size mismatch"
